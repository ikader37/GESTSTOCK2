 ...
 * @author DELL
 */
public class Rangement extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rangement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
